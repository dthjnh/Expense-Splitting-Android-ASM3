...
public class SelectablePaymentMethodAdapter2 extends RecyclerView.Adapter<SelectablePaymentMethodAdapter2.ViewHolder> {
    ...
    public SelectablePaymentMethodAdapter2(List<PaymentMethod> paymentMethods, OnPaymentMethodSelectedListener listener) {
